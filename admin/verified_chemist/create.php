...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (count($errors) > 0) {
        $_SESSION['Message'] = $errors;
            ...
            $sql = "insert into verified_chemist (id_chemist,id_analysis,verified) values ($id_chemist , $id_analysis ,'$verified')";
...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            displayMessages('Dashboard/Add verified');
        ...
        <div class="container">
            ...
            <div class="form-group">
                    <label for="exampleInputPassword">chemist name</label>
                ...
                <div class="form-group">
                    ...
                    <!-- <input type="text" class="form-control" id="exampleInputPassword1" name="verified" placeholder="verified"> -->
