...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (count($errors) > 0) {
        ...
        $sql = "update review_doc  set id_doc =  $id_doc , id_analysis = $id_analysis, review = '$review'   where id = $id";
        $op = mysqli_query($con, $sql);
...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            displayMessages('Dashboard/Edit review');
            ?>
        ...
        <div class="container">
            ...
            <form action="edit.php?id=<?php echo  $UserData['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="exampleInputType">doctor name</label>
                    <select class="form-control" name="id_doc">
                        ...
                        ?>
                            ...
                            <option value="<?php echo $Type_data['id']; ?>"   <?php if ($UserData['id_doc'] == $Type_data['id']) {  echo 'selected';} ?>>
