...
<html lang="en">
    ...
    <body style="background-image: url('../image/2m.jpg');">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header" style="background-image: url('../image/3m.png');"><h1 class="text-center font-weight-light my-4">Login</h1><h2</div>
                                    <div class="card-body">
